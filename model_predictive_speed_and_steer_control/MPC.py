...
show_TIME = 1.5 # simulation time in picture

# iterative paramter
MAX_ITER = 10  # Max iteration
DU_TH = 0.1  # iteration finish param

TARGET_SPEED = 180.0 / 3.6  # [m/s] target speed
...
MAX_SPEED = 180.0 / 3.6  # maximum speed [m/s]
MIN_SPEED = -20.0 / 3.6  # minimum speed [m/s]
MAX_ACCEL = 5.5  # maximum accel [m/ss]
